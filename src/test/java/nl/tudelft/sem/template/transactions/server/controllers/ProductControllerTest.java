...
class ProductControllerTest {
    ...
    @Test
    void addProduct() {
        Product addedProduct = productController.
                addProduct(product.getProductName(), product.getPrice(), product.getTotalPortions(), "Mark");
    ...
    void getUserProducts() {
        productController.addProduct(product.getProductName(), product.getPrice(), product.getTotalPortions(), "Mark");
